...
<?php
		...
		foreach($header_slider_newarrival as $result):
			$flag = 0;
			$input = '';
	...
	?>
                        ...
                        <div class="product-cart-wrap small hover-up product_<?= $result['inventory_id']?>">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#"><i class="fi-rs-eye"></i></a>
