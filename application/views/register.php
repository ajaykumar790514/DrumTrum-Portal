                    ...
                    <div class="theme-form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="mobile" placeholder="Mobile Phone Number" required="">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <label for="t_and_c"><a href="<?=base_url('terms')?>" target="_blank"style="color:#1b1818;">Terms & Conditions</a></label>
                                <p></p>
                            </div>                            
                        ...
                        <div class="col-md-6">
                             <img src="<?=base_url('uploads/photo/logo/signup.jpg');?>" class="img-fluid" alt="">
                        </div>
                        </div>
                    </div>
                    <!-- </form> -->
                    ...
                    <div class="theme-form">
                        <div class="row">
                           <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="address_l_3" placeholder="Address Line 3" >
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">                            
                          <div class="col-md-12">-->
                            ...
                            <div class="col-md-12">
                                <input type="checkbox" name="t_and_c" id="t_and_c" value="1" class="mb-0" required>
                                <label for="t_and_c"><a href="<?= POLICY_PATH.'policy/TermsConditions.pdf'; ?>" target="_blank"style="color:#1b1818;">Terms & Conditions</a></label>
                                <p></p>
                            </div>                            
                            <button type="button" class="btn btn-solid w-auto" onclick="create_account(this)">create Account</button>
                        </div>
                    ...
                    <form method="POST" class="theme-form" id="register-form-otp">                        
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" name="mobile" id="otp_mobile">
                            </div>  
