                                                ...
                                                <div class="card mb-lg-0">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <span class="badge bg-warning" id="badge" role="button" data-id="<?=$address->id?>">Default Address</span>
                                                            <?php else: ?>
                                                    ...
                                                    <div class="card-body">
                                                        <address><?= $address->house_no.' '.$address->address_line_2.' '.$address->address_line_3.' '.$address->city.' '.$address->state.' '.$address->country.' , '.$address->pincode ; ?></address>
                                                         <address  style="color: #999999 !important;">Landmark:<span class="text-dark"><?= $address->landmark ?> </span></address> 
                                                        <address  style="color: #999999 !important;">Phone: <span class="text-dark"><?= $address->contact; ?> </span></address>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="<?= $add_url ?>" class="saddress-form">
                ...
                <div class="modal-footer justify-content-between d-flex">
                    <button type="button" class="btn text-center btn-dark btn-solid" data-bs-dismiss="modal">CANCEL</button>
...
<div class="modal fade" id="delete-address-modal" tabindex="-1" role="dialog" aria-labelledby="delete-address" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between d-flex">
                <button type="button" class="btn text-center btn-solid bg-dark" data-bs-dismiss="modal">CANCEL
