...
<p id="edit-error-msg"></p>
 <div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="address_l_3"  value="<?= @$address->address_line_3; ?>" placeholder="Address Line 3" >
    </div>
    <!-- <div class="form-group col-sm-6">
        <label>Company</label>
    ...
    <div class="form-group col-sm-6">
        <label class="control-label">Mobile Phone Number <span class="required text-danger">*</span></label>
    ...
    <!-- <div class="form-group col-sm-6">
        <label>County <span class="required text-danger">*</span></label>
