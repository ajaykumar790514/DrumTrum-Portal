...
<!-- onload="window.print()" -->
    ...
    echo $timestring = $now->format('d-m-Y');?></b>
        ...
        <?php
          // discount
            ...
            <tr>
                ...
                <td style="border:2px solid black;height:40px;width:29.2%;text-align:center;font-family:  Arial, Helvetica, sans-serif;"><?= $row['product_name']; ?> <?=$row['item_props_value']?></td>
                <td style="border:2px solid black;height:40px;width:10%;text-align:center;font-family:  Arial, Helvetica, sans-serif;"><?= $row['sku']; ?></td>
       ...
       //echo $invoice[0]['state_name'];
        ...
        <div id="total-amount">
		  	<p>Total Amount (in words) : <strong>INR <?= number_to_word($invoice[0]['total_value']); ?></strong></p>
		</div>
        <hr>
