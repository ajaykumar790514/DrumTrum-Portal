<style>
.bannerbg{   
     /*background: url('<?=IMGS_URL?>banners/topbannerbg.gif');*/
...
.col-md-12 #shop_now
{
    margin-left: 43rem;
    margin-top: -13rem;
    background-color: #fed91c !important;
    padding: 6px 8px;
}
#wows1_0
{
        ...
        <div class="row flex-nowrap text-center" >
                 <?php  foreach($category as $row): ?>
                    <div class="col-3" style="margin:10px 1px 1px 1px;border-radius: 10px"> 
                     ...
                     <div class="img-block"> 
                      <a href="<?=base_url()?>categories/<?php if($row->url !=''){ echo $row->url;}else{ echo 'null';}?>">
                       <img src="<?= IMGS_URL.$row->thumbnail; ?>" class="img-fluid" alt="" style="width: 85px;height:75px;border-radius: 10px">
                      </a>
                     </div>
                      </div>
                     <h6 class="p-name-media mt-1"> <a href="<?=base_url()?>categories/<?php if($row->url !=''){ echo $row->url;}else{ echo 'null';}?>"><?=$row->name?></a></h6>
                    </div>
                 <?php endforeach; ?>
       </div>
 </div>
...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    <div class="carousel-indicators">
        <?php foreach ($banners_top as $key => $top): ?>
            <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="<?= $key ?>" class="<?php if($key == 0) echo 'active'; ?>" aria-current="<?php if($key == 0) echo 'true'; ?>" aria-label="Slide <?= $key + 1 ?>"></button>
        <?php endforeach; ?>
    </div>
        ...
        <?php foreach ($banners_top as $key => $top): ?>
            <div class="carousel-item <?php if($key == 0) echo 'active'; ?>" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <!-- Optionally display slide captions here -->
                    <h4 style="color:black"><?=$top->banner_title;?></h4>
                    <h5 class="mb-3"><?=$top->banner_offer;?></h5>
                    <a href="<?=base_url();?><?php if($top->link_type==1){echo 'products';} ;?>/<?=$top->link_id;?>" class="btn btn-solid" style="font-size:12px;background-color:#fed91c;padding:6px 8px !important;">Shop Now</a>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
    ...
    <div class="container" style="max-width:100%;padding:0;margin:0"  >
		<div id="slider" class="carousel slide " data-bs-ride="carousel"   >
			<div class="carousel-inner" >
                <?php
                $i=0;
                foreach($banners_top as $top):?>
            <div class="<?= ($i==0)?'carousel-item active':'carousel-item' ?>" style="background-color:<?=$top->banner_color;?>">
					<div class="row" >
					    <div class="col-lg-6 col-md-6 mb-3 align-self-center">
							<div class="p-4" >
								<h2 style="font-size:300%;" ><?=$top->banner_offer;?></h2>
								 <br>  
                                 <a href="<?=base_url();?><?php if($top->link_type==1){echo 'products';} ;?>/<?=$top->link_id;?>" class="btn btn-solid" style="font-size:12px;background-color:#fed91c;padding:6px 8px !important;">Shop Now</a>
								<h3 style="font-size:12px;" class="mt-3 pl-5"><?=$top->banner_title;?> </h3>
							</div>
						</div> 
					    <div class="col-lg-6 col-md-6  align-self-center">
						 <a href="<?=base_url();?><?php if($top->link_type==1){echo 'products';} ;?>/<?=$top->link_id;?>">	<img src="<?=IMGS_URL.$top->img?>" alt="" title="Only £2.99" id="wows1_0" class="w-100"/>
						  </a>
						 </div> 
					</div>	
				</div>	
        ...
        <div class="slider-7 no-arrow">
            <div>
                <div class="category-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/icon-categories-8-1-1.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Stuffed Toys</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/icon-categories-8-1.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Jigsaw Puzzle</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/icon-categories-8-3.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Smart Toys</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/icon-categories-8-4.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Movement Toys</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/icon-categories-8-5.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Control Toys</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/icon-categories-8.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Wooden Toys</h5></a>
                    </div>
                </div>
            </div>
            <div>
            ...
            <div class="col-md-8 p-2">
              <?php foreach($banners_other as $row) :
                           if($row->seq==1):
                            ...
                            <div class="collection-banner collection-banner-new3 border-0 p-center text-center">
                            <div class="img-part">
                                <img src="<?= IMGS_URL.$row->img; ?>" class=" img-fluid bg-img" alt="">
                            </div>
                ...
                <div class="row partition-3">
                     <div class="col-md-12 p-2">
                           ...
                           if($row->seq==2):
                            ?>
                             <a href="<?=($row->link_type==2)?base_url('products/'._encode($row->link_id)):'#'  ?>" >
                            <div class="collection-banner collection-banner-new4 border-0 p-center text-center">
                            <div class="img-part">
...
<section class="slider-section slider-layout-4">
    <div class="container">
        ...
        <div class="containers" style="margin-top: -3.3rem;">
        <div class="slider-10 pt-3 pb-3 pl-3 pr-3">
            <?php foreach($rs1  as $r1): ?>
            <div>
                <div class="category-wrapper newcategory-wrapper">
                    <div class="img-block">
                        <a href="<?php if($r1->level==2){ if($r1->url !=''){ echo "category/".$r1->url;}else {   echo "category/null"; }}elseif($r1->level==3){if($r1->url !=''){ echo "category/".$r1->url;}else {   echo "category/null"; }} ;?>"><img src="<?=IMGS_URL.$r1->icon;?>" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="<?php if($r1->level==2){ echo "category/".$r1->url;}elseif($r1->level==3){echo "category/".$r1->url;} ;?>"><h5><?=$r1->name;?></h5></a>
                    </div>
                </div>
            </div>
            <?php endforeach;?>
    ...
    <div class="containers" style="margin-top: -3.3rem;">
        <div class="slider-10 pt-3 pb-3 pl-3 pr-3">
            ...
            <div>
                <div class="category-wrapper newcategory-wrapper ">
                    <div class="img-block">
                        <a href="<?php if($r2->level==2){ if($r2->url !=''){ echo "category/".$r2->url;}else {   echo "category/null"; }}elseif($r2->level==3){ if($r2->url !=''){ echo "category/".$r2->url;}else {   echo "category/null"; }} ;?>"><img src="<?=IMGS_URL.$r2->icon;?>" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="<?php if($r2->level==2){ if($r2->url !=''){ echo "category/".$r2->url;}else {   echo "category/null"; }}elseif($r2->level==3){ if($r2->url !=''){ echo "category/".$r2->url;}else {   echo "category/null"; }} ;?>"><h5><?=$r2->name;?></h5></a>
                    </div>
                </div>
            </div>
            <?php endforeach;?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12 pe-0 ratio_square">                
                <div class="tab-head">
                    <!-- <h2 class="title" id="header_title"><?=$row->title?></h2> -->
                    <h2 class="title" id="header_title">Shop By Character</h2>
                </div>
                <!-- <div id="header-home-cat-<?=$row->id?>">
    ...
    <div class="containers" style="margin-top: -3.3rem;">
        <div class="slider-10 pt-3 pb-3 pl-3 pr-3">
            <div>
                <div class="category-wrapper newcategory-wrapper ">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/chac1.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Barbie</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper newcategory-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/chac2.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Marvel</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper newcategory-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/chac3.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Lucky Luke</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper newcategory-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/chac4.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Disney Princess</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper newcategory-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/chac5.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Harry Porter</h5></a>
                    </div>
                </div>
            </div>
            <div>
                <div class="category-wrapper newcategory-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/chac6.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Wooden Toys</h5></a>
                    </div>
            ...
            <div>
                <div class="category-wrapper newcategory-wrapper">
                    <div class="img-block">
                        <a href="#"><img src="<?=base_url();?>uploads/photo/logo/chac7.png" alt="" class=" img-fluid"></a>
                    </div>
                    <div class="category-title">
                        <a href="#"><h5>Barbie</h5></a>
                    </div>
            ...
            <!-- <script>
                $(document).ready(function(){
                    setTimeout(()=> {
                        $("#header-home-cat-<?=$row->id?>").load("<?=base_url()?>home/header_cat_slider/<?=$row->id?>");
                    }, 100);                                           
                });                       
            </script> -->
...
<div class="col-md-12 ">
                ...
                ?>
                <a href="<?=($row->link_type==2)?base_url('products/'._encode($row->link_id)):'#'  ?>" >
                    <img src="<?= IMGS_URL.$row->img; ?>" class="img-fluid baner-img w-100">
                </a>
                <button type="button" class="btn  btn-solid" id="shop_now">SHOP NOW</button>
                <?php
                    endif;                    
                    endforeach;            
                ?>
...
<!-- new other banner -->
<!-- <section>
    <div class="containers" style="margin-top: -4rem;">
        <div class="row">
            <div class="col-md-12">
            <?php foreach($banners_other as $row) :
                 if($row->seq==4):
            ...
            <div class="col-md-3 p-2">
              <?php foreach($banners_other as $row) :
                           if($row->seq==4):
                            ?>
                             <a href="<?=($row->link_type==2)?base_url('products/'._encode($row->link_id)):'#'  ?>" >
                            <div class="collection-banner collection-banner-new1 border-0 p-center text-center">
                            <div class="img-part">
                                <img src="<?= IMGS_URL.$row->img; ?>" class=" img-fluid bg-img" alt="">
                            </div>
                            <!--<div class="contain-banner">-->
                ...
                <div class="row partition-3">
                     <div class="col-md-4 p-2">
                           ...
                           if($row->seq==5):
                            ?>
                             <a href="<?=($row->link_type==2)?base_url('products/'._encode($row->link_id)):'#'  ?>" >
                            <div class="collection-banner collection-banner-new2 border-0 p-center text-center">
                            <div class="img-part">
...
<section class="blog-section grey-bg section-b-space ratio3_2">
    <div class="container">
    <h2 class="title text-center testimonial-title mb-5">Testimonial</h2>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="slide-testimonial">
                        <div>
                            <div class="review-content">
                                <div class="avtar">
                                    <img src="<?=base_url();?>uploads/photo/testimonial/2.jpg" alt="">
                                </div>
                            
                                 <h5>Shivam</h5>
                                <h6>Kanpur</h6>
                              
                                <p>There was a time when my 14-year-old sister was in a rebellious phase. She was angry at everyone, including herself. She did the whole goth thing - black hair, black eyeliner, black lipstick.
                           
She came stomping down the stairs one evening.</p>
                            </div>
                        </div>
                        <div>
                            <div class="review-content">
                                <div class="avtar">
                                    <img src="<?=base_url();?>uploads/photo/testimonial/3.jpg" alt="">
                                </div>
                                 <h5>Shivam</h5>
                                <h6>Kanpur</h6>
                                <p>There was a time when my 14-year-old sister was in a rebellious phase. She was angry at everyone, including herself. She did the whole goth thing - black hair, black eyeliner, black lipstick.
...
She came stomping down the stairs one evening.</p>
                        ...
                        <div>
                            <div class="review-content">
                                <div class="avtar">
                                    <img src="<?=base_url();?>uploads/photo/testimonial/4.jpg" alt="">
