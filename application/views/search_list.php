        ...
        <div class="row">
            <!-- <div class="col-12">
                <div class="page-title">
                    <h4>Search Sheffield's Vape Outlet</h4>
                </div>
            </div> -->
            <div class="col-12">
                <nav aria-label="breadcrumb" class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Search DrumTrum</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-3 collection-filter">
                    ...
                    <div class="collection-filter-block">
                        ...
                        <?php foreach($props_filter as $prop): ?>
                            <div class="collection-collapse-block prop-filter">
                                <h3 class="collapse-block-title"><?= $prop->name; ?></h3>
                                <div class="collection-collapse-block-content" style="display: none;">
                                    <div class="collection-brand-filter">
                                        <?php 
                                        $query = $this->db->where('props_id', $prop->id)->group_by('value_id')->get('product_props')->result();
                                                                    ...
                                                                    ele += `<div class="product-box product-cart-wrap product_${value.id}"">`
                                                                            ...
                                                                            ele += `<div class="product-info">`
                                                                                ...
                                                                                if (value.flavour_name !=null) {
                                                                                    ele += `<a href="${value.detail_page}"><h6 class="text-uppercase"><strong>${value.flavour_name}</strong></h6></a>`
                                                                                }else{
                                                                                ...
                                                                                ele += `<a href="${value.detail_page}"><h6 class="p-name  mt-1" style="height: 16px; overflow:hidden;">${value.product_name}</h6></a>`
                                                                                    ...
                                                                                    if (value.product_qty > 0) {
                                                                                        // if(value.flag==1)
                                                                                        // {
                                                                                        //     ele += `<button class="btn btn-solid btn-solid-sm quick-btn mt-1" onclick="openProductSidebar(${value.product_id})" style="margin-top:-50px"><i class="fa fa-plus"></i> Quick Add</button>`
                                                                                        // }else
                                                                                        // {
                                                                                            ele += `<button class="btn btn-solid btn-solid-sm quick-btn" onclick="openProductSidebar(${value.product_id})"><i class="fa fa-plus"></i> Quick Add</button>`
                                                                                    //    }
