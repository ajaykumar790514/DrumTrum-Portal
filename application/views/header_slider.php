    ...
    <div>
        <div class="product-box">
               ...
               <!--  <a href="<?=base_url('product-detail/'.$result["inventory_id"].'/'._encode($result["category_id"]).'/'._encode($result["category_id"]))?>">
                ...
                <div class="lable-wrapper">
                    <?php
                        ...
                        if(!empty($offerss))
                        {
                            ?><span class="lable6" style="top:2rem;"><?=$deatailoffervalue;?></span>
                     <?php   }else{
                        $deal_count = 0;
            ...
            <div class="product-info product-content">
                ...
                <?php
                  $pronameout = strlen($result['name']) > 40 ? substr($result['name'],0,40)."..." : $result['name'];
                           ?>
                ...
                <a href="<?=base_url('product-detail/'.$result["inventory_id"].'/'._encode($result["category_id"]).'/'._encode($result["category_id"]))?>"><h6 class="p-name mt-1"><?=$pronameout?></h6></a> -->
                  <a href="<?=base_url('product/')?><?php if($result['url'] !=''){echo $result['url'];}else{echo 'null';} ;?>"><h6 class="text-uppercase"><strong><?=$result['flavour_name'] ?></strong></h6></a>

                <a href="<?=base_url('product/')?><?php if($result['url'] !=''){echo $result['url'];}else{echo 'null';} ;?>"><h6 class="p-name mt-1"><?=$pronameout?></h6></a>
                
                            <!-- <?php if ($result['mrp'] > $selling_rate) {?>
                                    <h4 class="old-price"><del class="d-save text-danger"><?= $shop_detail->currency; ?><span class="d-mrp text-danger"><?php echo number_format((float)($result['mrp']), 2, '.', '') ;?></span></del></h4>
                                    <?php }else{ echo "<h4 class='old-price'></h4>";}?> -->
                      ...
                      <h4 class="text-rupee-new new-price"><?= $shop_detail->currency; ?><span class="d-rate"><?php echo number_format((float)($deatailfinalamount), 2, '.', '') ;?></span></h4>
                         <?php  }else{?>
                            <h4 class='old-price'></h4>
                            <h4 class="text-rupee-new pt-1 new-price">MRP.  <?= $shop_detail->currency; ?><span class="d-rate"><?php echo number_format((float)($selling_rate), 2, '.', '') ;?></span></h4>
                        <?php }?>
