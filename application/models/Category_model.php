...
class Category_model extends CI_Model
{
    ...
    {
        $query = $this->db->order_by('seq','asc')->get_where('products_category', ['is_parent' => '0','is_deleted'=>'NOT_DELETED', 'active'=>1]);
        return $query->result();
    }
 
    public function get_categoryById($id)
    {
        $query = $this->db->order_by('seq','asc')->get_where('products_category', ['is_parent' => $id,'is_deleted'=>'NOT_DELETED', 'active'=>1]);
        return $query->result();
    }
