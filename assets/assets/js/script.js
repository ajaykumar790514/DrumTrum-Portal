...
(function($) {
    ...
    $(document).on('click', '.close-cart, .closeCartbox', function() {
...
/*=====================
 ...
 function openAddress() {
    document.getElementById("address_side").classList.add('open-side');
}
function closeAddress() {
    document.getElementById("address_side").classList.remove('open-side');
}
...
function openProductSidebar(pid) {
    document.getElementById("product_sidebar_side").classList.add('open-side');
    $("#product_side").load(base_url+'home/product_sidebar/'+pid);
}
function closeProductSidebar() {
    document.getElementById("product_sidebar_side").classList.remove('open-side');
}

function openProductDescSidebar(pid) {
    document.getElementById("product_desc_sidebar_side").classList.add('open-side');
    $("#product_desc_side").load(base_url+'home/product_desc_sidebar/'+pid);
}
function closeProductDescSidebar() {
    document.getElementById("product_desc_sidebar_side").classList.remove('open-side');
}
